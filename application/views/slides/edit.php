		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="<?php echo base_url()?>post/page/about"><i class="glyphicon glyphicon-book"></i>About</a></li>a></li>
                    <li class="submenu">
                         <a href="#">
		  	...
		  	<div class="row">
		  		<div class="col-md-12 panel-info">
		  			<div class="content-box-header panel-heading">
	  					<div class="panel-title ">Edit Slides :: <?php echo $sh->title; ?></div>
		  			...
		  			<div class="col-md-6 col-sm-6 col-xs-6">
		  					<form method="post" action="<?php echo base_url()?>slides/update" enctype="multipart/form-data">
		  			  ...
		  			  <div class="col-md-6 col-sm-6 col-xs-6">
		  			  	...
		  			  	<?php echo $this->session->flashdata('message'); ?>
		  					<p>Pellentesque luctus quam quis consequat vulputate. Sed sit amet diam ipsum. Praesent in pellentesque diam, sit amet dignissim erat. Aliquam erat volutpat. Aenean laoreet metus leo, laoreet feugiat enim suscipit quis. Praesent mauris mauris, ornare vitae tincidunt sed, hendrerit eget augue. Nam nec vestibulum nisi, eu dignissim nulla.
								...
								<p>Image Preview</p>
								<img src="<?php echo base_url().'assets/images/slides/'.$sh->image;?>" class="img-responsive">
		  				</div>
		  			</div>			  			
					</div>
		  		</div>
